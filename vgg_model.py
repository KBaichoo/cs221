...
def eval_model(vgg, criterion):
    """
    Helps with accuracy on the test set.
    """
    since = time.time()
    avg_loss = 0
    avg_acc = 0
...
# TODO(kbaichoo): modify this for training if we want to do training...
...
if resume_training:
    ...
    vgg16.load_state_dict(torch.load(
        '../input/vgg16-transfer-learning-pytorch/VGG16_v2-OCT_Retina.pt'))
    print("Loaded!")
